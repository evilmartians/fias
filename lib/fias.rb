...
Fias.configure do |config|
  ...
  config.add_name('поселок', 'п.', aliases: %w(пос посёлок))
  ...
  config.add_name('деревня', 'д.', aliases: %w(дер))
  ...
  config.add_name('квартал', 'кв-л', aliases: ['кварт'])
  ...
  config.add_name('шоссе', 'ш.', aliases: ['шос'])
  ...
  config.add_name('коттеджный поселок', 'кп', aliases: ['коттеджный'])
