...
describe Fias::Name::Long do
  {
    ...
    'коттеджный поселок Морозов' => ['Морозов', 'коттеджный поселок', 'кп', 'кп'],
    'поселок городского типа Свердловский' => ['Свердловский', 'поселок городского типа', 'пгт', 'пгт'],
    'поселок Павловская Слобода' => ['Павловская Слобода', 'поселок', 'п', 'п.'],
    'Павловская Слобода поселок' => ['Павловская Слобода', 'поселок', 'п', 'п.'],
    ...
    'Морозов коттеджный поселок' => ['Морозов', 'коттеджный поселок', 'кп', 'кп'],
    '' => nil,
    nil => nil,
